...
const WHY_POINTS = [
  ...
  { label: 'Visa Success Rate', icon: '✅', number: '95%' },
  { label: 'Happy Travellers', icon: '❤️', number: '500+' },
];

const FOUNDER_REELS = [
  { id: 1, url: 'https://www.instagram.com/reel/DUknggZkvcV/', headline: '7 Days in Bali + Gili Island' },
  { id: 2, url: 'https://www.instagram.com/reel/DVFmfnGkrLD/', headline: 'Europe in 10 Nights' },
  { id: 3, url: 'https://www.instagram.com/reel/DU2ITdsknID/', headline: 'Maldives on a Budget' },
  { id: 4, url: 'https://www.instagram.com/reel/DU8N9ssEilU/', headline: 'Dubai Long Weekend' },
  { id: 5, url: 'https://www.instagram.com/reel/DUpHwITEgS8/', headline: 'Kashmir in Winter' },
  { id: 6, url: 'https://www.instagram.com/reel/DUxjDVJkkeO/', headline: 'Kerala Backwaters' },
  { id: 7, url: 'https://www.instagram.com/reel/DUulX9oEjY6/', headline: 'Singapore with Kids' },
  { id: 8, url: 'https://www.instagram.com/reel/DUhhqNbknNP/', headline: 'Vietnam Highlights' },
  { id: 9, url: 'https://www.instagram.com/reel/DUa2c6Kkt8o/', headline: 'Sri Lanka Circuit' },
  { id: 10, url: 'https://www.instagram.com/reel/DUS7ML7kpun/', headline: 'Andaman Islands' },
  { id: 11, url: 'https://www.instagram.com/reel/DULlx6jknDL/', headline: 'Turkey in 8 Days' },
  { id: 12, url: 'https://www.instagram.com/reel/DUGAUAEkhh6/', headline: 'Thailand Highlights' },
];
            ...
            {FOUNDER_REELS.map(reel => (
              ...
              >
                <div className="reel-thumb">
                  <img
                    src={`https://picsum.photos/seed/sh${reel.id}/400/700`}
                    alt={reel.headline}
                    loading="lazy"
                  />
